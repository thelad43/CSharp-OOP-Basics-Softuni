    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            for (int row = 0; row < n; row++)
            {
                ...
                room[row] = inputAsCharArray;
            }

            var moves = Console.ReadLine().ToCharArray();
            var samPos = new int[2];
            ...
            foreach (var move in moves)
            {
                ...
                if (samPos[1] < nikoladzePos[1] && room[nikoladzePos[0]][nikoladzePos[1]] == 'd' &&
                    nikoladzePos[0] == samPos[0] || nikoladzePos[1] < samPos[1] &&
                    room[nikoladzePos[0]][nikoladzePos[1]] == 'b' && nikoladzePos[0] == samPos[0])
                {
